...
import { BookPlusIcon, Edit, MoreHorizontal, PenBoxIcon, PlusCircle } from "lucide-react";
import { SemesterCourse, addEnrolledCourses } from "../../../../firebase/db_fun";
import { auth } from "../../../../firebase/firebaseApp";

import { refreshPage } from "@/lib/utils";
import { useState } from "react";
import { EditCourseModal } from "@/components/modals/edit_course_modal";
...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
    ...
    // const editCourse = async (data: CourseListColumn | undefined) => {
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={
                    ...
                    <PenBoxIcon className="h-4 mr-2 w-4" />
                    Edit Course
                </DropdownMenuItem>
